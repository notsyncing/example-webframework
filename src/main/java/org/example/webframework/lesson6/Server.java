...
import org.example.webframework.lesson6.file.StaticFileHandler;
import org.example.webframework.lesson6.session.SessionHandler;
import org.example.webframework.lesson6.template.TemplateHandler;
...
public class Server {
    ...
    public static void main(String[] args) throws IOException {
        new Server()
                ...
                .addHandler(new TemplateHandler())
