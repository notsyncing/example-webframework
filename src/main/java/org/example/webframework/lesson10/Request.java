...
import org.example.webframework.lesson10.file.Range;
import org.example.webframework.lesson10.mvc.multipart.UploadedFile;
import org.example.webframework.lesson10.routing.MatchedRoute;
...
public class Request {
    ...
    public String getContentType() {
        ...
        if (parts.length > 1) {
            for (final var part : parts) {
                ...
                } else if ("boundary".equals(partName)) {
                    boundary = partValue;
                }
            }
        }
    ...
    public void addUploadedFile(UploadedFile info) {
