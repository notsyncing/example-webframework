...
import org.example.webframework.lesson11.cors.CorsConfig;
import org.example.webframework.lesson11.cors.CorsHandler;
import org.example.webframework.lesson11.file.StaticFileHandler;
import org.example.webframework.lesson11.filter.FilterHandler;
import org.example.webframework.lesson11.mvc.MvcHandler;
import org.example.webframework.lesson11.routing.SimpleRoute;
import org.example.webframework.lesson11.session.SessionHandler;
...
public class Server {
    ...
    public static void main(String[] args) throws IOException {
        CorsHandler.addConfig(new SimpleRoute(null, "/order/{id}"), new CorsConfig()
                .allowOrigins("*")
